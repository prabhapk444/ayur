...
<div data-aos="fade-up"
     ...
     <h1>Ayurvedic Management System</h1>
</div>
    ...
    if ($result) {
        ...
        if ($user) {
            if (password_verify($password, $user['Password'])) {
                ...
                echo "<script>Swal.fire('Incorrect password', '', 'error');</script>";
            }
        } else {
        
            echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@10'></script>";
            echo "<script>Swal.fire('Username not found', '', 'error');</script>";
        }
    } else {
        
        echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@10'></script>";
        echo "<script>Swal.fire('Database error', '', 'error');</script>";
    }
