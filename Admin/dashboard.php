...
echo "<marquee>Welcome, $username!</marquee>";?>
    ...
    <div class="main">
        <?php
            ...
            $reviewCountQuery = "SELECT COUNT(*) AS total_reviews FROM user_reviews";
            $reviewResult = $conn->query($reviewCountQuery);

            $paymentCountQuery = "SELECT COUNT(*) AS total_payments FROM payment";
            $paymentResult = $conn->query($paymentCountQuery);
            ...
            if ($productResult === false || $reviewResult === false || $paymentResult === false || $userResult === false || $orderResult === false) {
                ...
                $totalPayments = $paymentRow['total_payments'];
                ...
                echo "<div class='col'>";
                echo "<p class='counter-value' data-count='$totalReviews'>$totalReviews</p>";
                echo "<p>Total Reviews</p>";
                echo "</div>";
            
                echo "<div class='col'>";
                echo "<p class='counter-value' data-count='$totalPayments'>$totalPayments</p>";
                echo "<p>Total Payments</p>";
                echo "</div>";
            
                echo "<div class='col'>";
                echo "<p class='counter-value' data-count='$totalUsers'>$totalUsers</p>";
...
if ($result->num_rows > 0) {
    ...
    echo "<thead class='thead-primary'><tr><th>S.No</th><th>Username</th><th>Email</th><th>Address</th></tr></thead><tbody>";
...
?>
  ...
  <marquee behavior="scroll" direction="left" class="color-change">Payment</marquee>
