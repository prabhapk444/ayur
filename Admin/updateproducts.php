...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uploadsPath = $_SERVER['DOCUMENT_ROOT'] . "/ayur/uploads/";
    ...
    $sql = "UPDATE products SET product_name=?, category=?, description=?, price=?, quantity=?, availablequantity=?, image=? WHERE product_id=?";

    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "sssssssi", $productName, $category, $description, $price, $quantity, $availability, $targetFile, $productId);
